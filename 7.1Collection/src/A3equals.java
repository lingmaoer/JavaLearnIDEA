...
//public class A3equals {
//    public static void main(String[] args) {
//        List<Person3> list = List.of(
//                new Person3("Xiao Ming"),
//                new Person3("Xiao Hong"),
//                new Person3("Bob")
//        );
//        System.out.println(list.contains(new Person3("Bob"))); // false
//    }
//}
//
//class Person3 {
...
public class A3equals {
    public static void main(String[] args) {
        List<Person3> list = List.of(
                new Person3("Xiao", "Ming", 18),
                new Person3("Xiao", "Hong", 25),
                new Person3("Bob", "Smith", 20)
        );
...
class Person3 {
    ...
    @Override
    public boolean equals(Object o){
        if(o instanceof Person3 p){
            return p.lastName.equals(this.lastName)&&
