/**
 * @author Lingmao
 * @creat 2021-10-06  10:55
 */

//来自https://www.liaoxuefeng.com/wiki/1252599548343744/1260454185794944
 ...
 */
//public class A2ConstructionMethod {
...
那前面我们并没有为 Person 类编写构造方法，
为什么可以调用 new Person()？

原因是如果一个类没有定义构造方法，编译器会自动为我们生成一个默认构造方法，
它没有参数，也没有执行语句，类似这样：
...
要特别注意的是，如果我们自定义了一个构造方法，那么，
编译器就不再自动创建默认构造方法：
 */

//public class A2ConstructionMethod {
//    public static void main(String[] args) {
//        Person1 p = new Person1(); // 编译错误:找不到这个构造方法
//    }
//}
//
//class Person1 {
...
//public class A2ConstructionMethod {
//    public static void main(String[] args) {
//        Person1 p1 = new Person1("Xiao Ming", 15); // 既可以调用带参数的构造方法
//        Person1 p2 = new Person1(); // 也可以调用无参数构造方法
//    }
//}
//
//class Person1 {
