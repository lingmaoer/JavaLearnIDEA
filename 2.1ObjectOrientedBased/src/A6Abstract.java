...
/**
 * @author Lingmao
 * @creat 2021-10-06  15:31
 */

//来自  https://www.liaoxuefeng.com/wiki/1252599548343744/1260456371027744
...
//    @Override
//    public void run(){
//        System.out.println("Student6 is run");
//    }
//}
...
public class A6Abstract {
    public static void main(String[] args) {
        ...
        income[] incomes = new income[] { new baseincome6(3000),new salaryIncome(7500), new royaltyIncome(12000) };
        double total = 0;
...
class baseincome6 extends income{
    public baseincome6(double income){
        super(income);
    }
