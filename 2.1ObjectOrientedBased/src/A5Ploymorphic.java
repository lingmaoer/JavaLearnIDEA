/**
 * @author Lingmao
 * @creat 2021-10-06  12:10
 */

//来自 https://www.liaoxuefeng.com/wiki/1252599548343744/1260455778791232
...
Override 和 Overload 不同的是，如果方法签名不同，就是 Overload，
Overload 方法是一个新方法；如果方法签名相同，并且返回值也相同，就是 Override。
...
class RoyaltyIncome extends Income{
    ...
    // TODO
    public RoyaltyIncome(double incom){
        super(incom);
    }
