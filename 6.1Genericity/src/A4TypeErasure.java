 ...
 */
//public class A4TypeErasure {
//    public static void main(String[] args) {
//        Pair4<String> p1 = new Pair4<>("Hello", "world");
//        Pair4<Integer> p2 = new Pair4<>(123, 456);
//        Class c1 = p1.getClass();
//        Class c2 = p2.getClass();
//        System.out.println(c1==c2); // true
//        System.out.println(c1==Pair4.class); // true
//
//    }
//}
//class Pair4<T> {
...
public class A4TypeErasure {
    public static void main(String[] args) {
        Class<IntPair4> clazz = IntPair4.class;
...
class IntPair4 extends Pair4<Integer> {
    public IntPair4(Integer first, Integer last) {
        super(first, last);
    }
}
